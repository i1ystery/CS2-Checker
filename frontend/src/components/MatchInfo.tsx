      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          ...
          <a
            ...
            className="inline-flex items-center gap-2 mt-4 px-4 py-2 bg-[#FF5500] hover:bg-[#ff6a1a] rounded-lg font-semibold transition-colors text-sm text-black"
          >
        ...
        <div className="flex items-center gap-2 sm:gap-4 justify-center sm:justify-end">
          <div className={`text-center px-3 sm:px-6 py-2 sm:py-3 rounded-lg flex-1 sm:flex-none min-w-[80px] sm:min-w-0 ${isFaction1Win ? 'bg-green-900/30 border border-green-700/50' : 'bg-gray-800/50 border border-gray-700/50'}`}>
